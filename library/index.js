...
console.log(
	'нет плавного затухания, есть только появление, остальные пункты вроде выполнены. Хотя при тесте пару раз ловил баг с вылетом из учетки, при повторном заходе все работает нормально',
	'Купленные книги не сохранял (после выхода из учетки), такого требования вроде нигде нету',
